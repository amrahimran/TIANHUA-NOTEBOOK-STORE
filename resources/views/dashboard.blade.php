<x-app-layout>
    <div class="max-w-[1500px] mx-auto mt-0 mb-6">
        <div class="max-h-[600px] relative">
            <img class="hero-image w-full max-h-[600px] object-cover" src="{{ asset('images/heroslides/slide1.png') }}" alt="slide image">
        </div>
    </div>
                    ...
                    <div class="w-[250px] md:w-[370px] h-[430px] mb-2 flex-shrink-0 bg-white shadow-lg shadow-gray-200 rounded-lg overflow-hidden transform transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-xl">
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{ route('product.show', $product->id) }}"></a>
                                <button class="bg-accent-color text-white px-4 py-2 rounded mt-2 w-full hover:bg-[#752c37]">View Details</button>
                            </a>
                        </div>
                    </div>
                @endif
